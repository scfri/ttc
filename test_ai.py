...
def test_find_diagonal_winner():
    ...
    assert aimee.find_diagonal_winner(solution_board) == Point(column='a', row=3)
    ...
    assert aimee.find_diagonal_winner(solution_board) == Point(column='b', row=2)
    ...
    assert aimee.find_diagonal_winner(solution_board) is None
